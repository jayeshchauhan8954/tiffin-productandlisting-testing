...
export default function RiderMessage({riderMsg, setRiderMsg = () => { }}) {
            ...
            <Grid container spacing={2}>
                {/* <Grid item xs={12} md={12}>
                    <CustomChip
                        ...
                        borderRadius={30}
                        fontSize={12}
                        sx={{ border: "1px thin", borderColor: theme.palette.primary.primaryGray2 }}
                ...
                <Grid item xs={12} md={12}>
                    <Typography variant='semiBoldText' color={theme.palette.primary.blackColor}>Add a note</Typography>
                    <TextField
                        sx={{ backgroundColor: theme.palette.primary.lighterGray, mt: 1, borderRadius: 1, borderColor: 1 }}
                        multiline
                        rows={4}
